...
import webdev from "./html.gif";
import app from "./applications.gif";
import content from "./content-marketing.gif";
import social from "./response.gif";
import ui from "./icons8-design.gif";
import digital from "./icons8-digital-marketing.gif";
import c from "./letter-c.png";
import brand from "./brand.gif";
import ad from "./ad marketing.gif";
import webdesign from "./web design.gif";
import frontend from "./frontend.png";
import backend from "./backend.png";
import js from "./java-script.png";
import ux from "./ui-ux (1).png";
...
import devOpsImg from "./agile.png";
